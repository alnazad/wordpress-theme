...
function my_customizer( $wp_customize ) {
   // Theme Options Panel
    ...
    $wp_customize->add_setting( 'n_logo', array(
        'capability'        => 'edit_theme_options',
        'default'           => '',
        'sanitize_callback' => 'ic_sanitize_image',
    ) );
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'n_logo',
        array(
            'label'    => __( 'n_logo', 'text-domain' ),
            'section'  => 'text_options',
            'settings' => 'n_logo',
        )
    ) );
...
add_action( 'customize_register', 'my_customizer' );
 ...
 //about------------------------------------------------
 require_once('sidebar/about.php');
// Client------------------------------
  require_once('sidebar/client.php');
 // testimonial---------------------
 require_once('sidebar/testimonial.php');
 // Team------------------------
 require_once('sidebar/team.php');
 //Facts------------------------
 require_once('sidebar/fact.php');
 require_once('sidebar/team.php');
 //Skills------------------------
 require_once('sidebar/skill.php');
 require_once('sidebar/team.php');
 //Service------------------------
 require_once('sidebar/service.php');
 require_once('sidebar/team.php');
 //Contract------------------------
 require_once('sidebar/contract.php');
